...
const MobileLearningAnimation = () => {
  ...
  const lessonCards = [
    ...
    { title: "Vocabulary", progress: "40%", delay: 0.4 },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          <text x="20" y="25" fontSize="12" fill="#6b21a8">Learn</text>
          <text x="60" y="25" fontSize="12" fill="#6b21a8">Practice</text>
          <text x="100" y="25" fontSize="12" fill="#6b21a8">Profile</text>
        </motion.g>
      </motion.g>
